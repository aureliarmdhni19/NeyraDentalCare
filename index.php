...
<head>
    ...
    <meta name="description"
        content="Klinik gigi Neyra Dental Care yang modern. Dikelola oleh mahasiswa Terapi Gigi Universitas Hasanuddin (UNHAS). Layanan profesional, tempat nyaman.">
    <meta name="keywords"
        content="klinik gigi, dokter gigi makassar, terapi gigi unhas, scaling gigi, tambal gigi, neyra dental care">
...
<body>
    ...
    <section id="beranda" class="hero">
        <div class="hero-content glass-panel">
            ...
            <p>Rasakan pengalaman perawatan kesehatan gigi premium dengan desain klinik yang estetik. Ditangani langsung
                oleh tim ahli kolaborasi dari Mahasiswa Terapi Gigi UNHAS.</p>
        ...
        <div class="tentang-kami-container">
            <div class="tentang-img">
                <img src="https://images.unsplash.com/photo-1606811841689-23dfddce3e95?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                    alt="Suasana Klinik Gigi Aesthetic">
            </div>
            <div class="tentang-text glass-panel">
                <h3>Dedikasi Dari Intelektual Muda UNHAS</h3>
                <p>Kami adalah inisiatif mandiri dari Mahasiswa Program Studi Terapi Gigi Universitas Hasanuddin
                    (UNHAS). Menggabungkan ilmu medis keperawatan gigi terkini dengan pendekatan hospitality modern.</p>
                <p>Klinik kami didesain dengan konsep <em>liquid glass aesthetic</em> untuk meminimalkan kecemasan
                    pasien (dental anxiety), menciptakan atmosfer relaksasi tingkat tinggi selama perawatan.</p>
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                        alt="Ruang Perawatan 1" />
                </div>
                <div class="swiper-slide">
                    <img src="https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                        alt="Peralatan Klinik" />
                </div>
                <div class="swiper-slide">
    ...
    <section id="reservasi">
        ...
        <div class="reservasi-container">
            ...
            <div class="reservasi-form glass-panel">
                ...
                <?php if (!$db_connected): ?>
                    <div class="alert alert-error">
                        Database belum dikonfigurasi. Form dimatikan sementara. Jalankan instruksi di file Panduan.<br><br>
                        <strong>Pesan Error (Debug):</strong><br>
                        <small><?php echo isset($db_error_message) ? htmlspecialchars($db_error_message) : 'Unknown Error'; ?></small>
                    </div>
                    <?php
                endif; ?>
                ...
                <form action="process_reservation.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama_pasien" class="form-control" required
                            placeholder="Cth: Andi M." <?php echo !$db_connected ? 'disabled' : ''; ?>>
                    </div>
                    <div class="form-group">
                        <label for="nohp">Nomor WhatsApp *</label>
                        <input type="tel" id="nohp" name="no_hp" class="form-control" required
                            placeholder="Cth: 081234..." <?php echo !$db_connected ? 'disabled' : ''; ?>>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="keluhan" name="keluhan" class="form-control"
                            placeholder="Jelaskan sedikit masalah gigi Anda..." <?php echo !$db_connected ? 'disabled' : ''; ?>></textarea>
                    </div>
            ...
            <div class="map-container">
                ...
                <iframe
                    src="https://maps.google.com/maps?q=RSGM%20Universitas%20Hasanuddin&t=&z=15&ie=UTF8&iwloc=&output=embed"
    ...
    <div class="floating-socials">
        <a href="https://wa.me/6281242754349?text=Halo%20Admin%20Neyra%20Dental%20Care,%20saya%20ingin%20berkonsultasi%20mengenai%20perawatan%20gigi%20saya.%0A%0ANama:%20%0AUsia:%20%0AKeluhan:%20"
            target="_blank" class="float-btn wa-btn" title="Chat WhatsApp">
            <i class="fa-brands fa-whatsapp"></i>
        </a>
        <a href="https://instagram.com/aaureliee___" target="_blank" class="float-btn ig-btn"
